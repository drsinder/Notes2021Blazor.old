...
namespace Notes2021.Manager
{
    public static class NoteDataManager
    {
        ...
        public static async Task<long> GetNumberOfNotes(ApplicationDbContext db, int fileid, int arcId)
        {
        ...
        public static async Task<long> GetNumberOfBaseNotes(ApplicationDbContext db, int fileid, int arcId)
        {
            List<NoteHeader> notes = await db.NoteHeader
        ...
        /// <returns></returns>
        private static IOrderedQueryable<NoteHeader> GetBaseNoteHeaderByIdRev(ApplicationDbContext db, int noteFileId, int arcId)
        {
        ...
        public static async Task<NoteHeader> GetNoteHeader(ApplicationDbContext db, long id)
        {
            return await db.NoteHeader
                .Where(p => p.Id == id)
                .FirstOrDefaultAsync();
        ...
        public static async Task<List<NoteHeader>> GetBaseNoteHeaders(ApplicationDbContext db, int id, int arcId)
        {
            return await db.NoteHeader
        ...
        public static async Task<List<NoteHeader>> GetBaseNoteAndResponses(ApplicationDbContext db, int nfid, int arcId, int noteord)
        {
            return await db.NoteHeader
                .Include("NoteContent")
                .Include("Tags")
        ...
        public static async Task<NoteHeader> GetNoteByIdWithFile(ApplicationDbContext db, long noteid)
        {
            return await db.NoteHeader
                .Include("NoteContent")
                .Include("NoteFile")
        ...
        public static async Task<List<NoteHeader>> GetBaseNoteAndResponsesHeaders(ApplicationDbContext db, int nfid, int arcId, int noteord)
        {
            return await db.NoteHeader
                .Where(p => p.NoteFileId == nfid && p.ArchiveId == arcId && p.NoteOrdinal == noteord)
                .ToListAsync();
        ...
        public static async Task<List<Tags>> GetNoteTags(ApplicationDbContext db, int nfid, int arcId, int noteord, int respOrd, int dummy)
        {
        ...
        /// <returns></returns>
        public static async Task<List<NoteHeader>> GetBaseNoteHeadersForNote(ApplicationDbContext db, int nfid, int arcId, int noteord)
        {
            return await db.NoteHeader
        ...
        public static async Task<NoteHeader> GetBaseNoteHeaderForOrdinal(ApplicationDbContext db, int fileid, int arcId, int ord)
        {
            return await db.NoteHeader
        ...
        public static async Task<NoteHeader> GetEditedNoteHeader(ApplicationDbContext db, NoteHeader edited)
        {
            return await db.NoteHeader
        ...
        public static async Task<NoteFile> GetFileByIdWithHeaders(ApplicationDbContext db, int id, int arcId)
        {
            NoteFile nf = await db.NoteFile
                .Where(p => p.Id == id)
                .FirstOrDefaultAsync();
        ...
        /// <returns></returns>
        public static async Task<NoteHeader> GetBaseNoteHeader(ApplicationDbContext db, int fileId, int arcId, int noteOrd)
        {
            return await db.NoteHeader
        ...
        /// <returns></returns>
        private static async Task<List<NoteHeader>> GetNoteContentList(ApplicationDbContext db, int fileId, int arcId, int noteOrd)
        {
            return await db.NoteHeader
                .Where(p => p.NoteFileId == fileId && p.ArchiveId == arcId && p.NoteOrdinal == noteOrd)
                .ToListAsync();
        ...
        public static async Task<List<NoteHeader>> GetSearchResponseList(ApplicationDbContext db, Search start, int myRespOrdinal, NoteHeader bnh, SearchOption so)
        {
            // First try responses
        ...
        public static async Task<List<NoteHeader>> GetSearchHeaders(ApplicationDbContext db, Search start, NoteHeader bnh, SearchOption so)
        {
            if (so == SearchOption.Tag)
            {
                return await db.NoteHeader
        ...
        public static async Task<List<NoteHeader>> GetSbnh(ApplicationDbContext db, Sequencer myseqfile)
        {
            return await db.NoteHeader
        ...
        public static async Task<List<NoteHeader>> GetSeqHeader1(ApplicationDbContext db, Sequencer myseqfile, NoteHeader bnh)
        {
            return await db.NoteHeader
                .Where(x => x.NoteFileId == myseqfile.NoteFileId && x.ArchiveId == 0
        ...
        public static async Task<List<NoteHeader>> GetSeqHeader2(ApplicationDbContext db, Sequencer myseqfile)
        {
            return await db.NoteHeader
        ...
        /// <param name="nfid">fileid</param>
        /// <returns></returns>
        public static async Task<List<NoteHeader>> GetBaseNoteHeadersForFile(ApplicationDbContext db, int nfid, int arcId)
        {
            return await db.NoteHeader
        ...
        public static async Task<List<NoteHeader>> GetOrderedListOfResponses(ApplicationDbContext db, int nfid, NoteHeader bnh)
        {
            return await db.NoteHeader
        ...
        public static async Task<NoteHeader> GetMarkedNote(ApplicationDbContext db, Mark mark)
        {
            return await db.NoteHeader
                .Include(m => m.NoteContent)
                .Include(m => m.Tags)
        ...
        public static async Task<NoteHeader> GetBaseNoteHeaderById(ApplicationDbContext db, long id)
        {
            return await db.NoteHeader
                .Where(p => p.Id == id)
                .FirstOrDefaultAsync();
